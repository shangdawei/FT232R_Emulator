...
/* Bit 8 ADCSW: ADC clock source selection : Obsolete setting. */
/* To be kept at reset value, connecting the HSI14 clock to the ADC asynchronous clock input. */
/* Proper ADC clock selection is done inside the ADC_CFGR2. */
