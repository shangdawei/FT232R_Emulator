...
#define ARM_USBD_EVENT_START            (1UL << 3)      // SetCfg or SetItf
#define ARM_USBD_EVENT_STOP             (1UL << 4)      // ClrCFg
...
#define USB_SETUP_PACKET_VALUE_HIGH( SetupPacket )   \
  ( ( (((USB_SetupPacket_TypeDef*)(SetupPacket))->wValue) >> 8 ) & 0xFF )
#define USB_SETUP_PACKET_VALUE_LOW( SetupPacket )    \
  ( ( (((USB_SetupPacket_TypeDef*)(SetupPacket))->wValue) >> 0 ) & 0xFF )

#define USB_SETUP_PACKET_INDEX_HIGH( SetupPacket )   \
  ( ( (((USB_SetupPacket_TypeDef*)(SetupPacket))->wIndex) >> 8 ) & 0xFF )
#define USB_SETUP_PACKET_INDEX_LOW( SetupPacket )    \
  ( ( (((USB_SetupPacket_TypeDef*)(SetupPacket))->wIndex) >> 0 ) & 0xFF )
